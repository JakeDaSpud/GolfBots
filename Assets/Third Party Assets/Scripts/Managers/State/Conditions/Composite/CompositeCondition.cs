...
namespace GD.State
{
    ...
    public class CompositeCondition : ConditionBase
    {
        ...
        protected override bool EvaluateCondition(GolfBots.State.ConditionContext context)
        {
        ...
        /// </summary>
        private bool EvaluateAndCondition(GolfBots.State.ConditionContext context)
        {
            bool allMet = true;
        ...
        /// </summary>
        private bool EvaluateOrCondition(GolfBots.State.ConditionContext context)
        {
            foreach (var condition in conditions)
            {
                if (condition.Evaluate(context))
        ...
        /// </summary>
        private bool EvaluateXorCondition(GolfBots.State.ConditionContext context)
        {
            int metCount = 0;
